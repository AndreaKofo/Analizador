...
public class Analizador extends javax.swing.JFrame implements ActionListener
{
	...
	private FileNameExtensionFilter filtro = new FileNameExtensionFilter("archivos con extensión .andi", "andi");
	...
	public Analizador()
	{
		...
		columnasSintactico.add("Acción");
                columnasSintactico.add("Semántica");
                columnasSintactico.add("Operadores");
                columnasSintactico.add("Posfijo");
                columnasSintactico.add("Código");
	...
	private void GuardarComo()
	{
		try
		{
			...
			jfc = new JFileChooser();
			jfc.setSelectedFile(new File("programa.andi"));
			jfc.setFileSelectionMode(JFileChooser.FILES_ONLY);
			jfc.setFileFilter(filtro);
	...
	private void analisisLexico()
	{
		...
		try
		{
			File temporal = new File("temporal.andi");
    ...
    private void initComponents() {
        ...
        etTitulo.setText("ANALIZADOR");

        bNuevo.setBackground(new java.awt.Color(255, 204, 204));
        bNuevo.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        bNuevo.setText("Nuevo");

        bAbrir.setBackground(new java.awt.Color(255, 204, 204));
        bAbrir.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        bAbrir.setText("Abrir");

        bGuardar.setBackground(new java.awt.Color(255, 204, 204));
        bGuardar.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        bGuardar.setText("Guardar");

        bGuardarComo.setBackground(new java.awt.Color(255, 204, 204));
        bGuardarComo.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        bGuardarComo.setText("Guardar Como");

        bCerrar.setBackground(new java.awt.Color(255, 51, 51));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPaneLexico, javax.swing.GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE))
        );
        ...
        bAnalizar.setBackground(new java.awt.Color(0, 255, 255));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(55, 55, 55)
                                .addComponent(etFuente, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE)
